...
def _watch(bot: Bot, update, isTar=False):
    ...
    try:
        ...
        msg += f"\n\nExample:\n<code>/{BotCommands.WatchCommand} https://youtube.com 720 | how to deploy</code>\n\n"
        msg += "This file will be downloaded in 720p quality and it's name will be <b>how to deploy</b>"
